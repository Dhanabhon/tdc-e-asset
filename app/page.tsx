          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <Link href="/dashboard" className="block">
                <Button
                  variant="outline"
                  className="w-full h-10 border-[#d8d2c2] bg-white hover:bg-[#f5f2ea] text-xs font-semibold text-[#211f1c] rounded-lg flex items-center justify-center gap-2 cursor-pointer"
                >
              ...
              <Link href="/dashboard" className="block">
                <Button className="w-full h-10 bg-[#211f1c] hover:bg-[#3a362f] text-[#f0eee6] text-xs font-semibold rounded-lg flex items-center justify-center gap-2 cursor-pointer">
