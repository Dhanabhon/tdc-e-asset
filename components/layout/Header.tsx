...
import { Search, Calendar, LogOut, Menu, X } from "lucide-react";
...
export function Header() {
  ...
  return (
    <>
      <header className="h-14 border-b border-[#e3ddcd] bg-[#faf9f5] px-4 sm:px-6 flex items-center justify-between shrink-0 gap-3">
        {/* Mobile Hamburger Toggle */}
        <button
          type="button"
          onClick={toggle}
          className="lg:hidden p-2 -ml-1 text-[#4a453d] hover:text-[#211f1c] hover:bg-[#eae7dc] rounded-lg transition-colors cursor-pointer shrink-0"
        ...
        <div className="flex items-center gap-4 flex-1 max-w-md">
          <form onSubmit={handleSearchSubmit} className="relative w-full">
            ...
            <Input
              ...
              placeholder="ค้นหารหัส, ชื่อ หรือ S/N..."
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          >
            ...
            <span className="text-xs font-semibold text-[#211f1c] hidden md:inline max-w-[120px] truncate">
